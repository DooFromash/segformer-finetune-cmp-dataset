...
class SegModel(nn.Module):
    def __init__(self, criterion, num_classes, load_imagenet_model, imagenet_ckpt_fpath, **kwargs):
        ...
        self.criterion = criterion # TODO: repo error
...
def get_seg_model(
    ...
    **kwargs
    ...
    model = SegModel(criterion=criterion,
...
if __name__=='__main__':
    ...
    criterions=[]
    #from mseg_semantic.model.criterion import Cross_sim_loss # TODO: repo error - cannot be fixed. module not found and not available in repo
